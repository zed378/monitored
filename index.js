...
// // Promisify the Redis client to use async/await
...
//     resave: false,
//     saveUninitialized: false,
//     cookie: { secure: false, maxAge: 60000 }, // Set cookie options (adjust `secure` in production)
//   })
// );
...
//   res
//     .status(err.status || 500)
//     .send(formatErrorToHTML("Error Has Been Occurred", err.stack));
// });

// // Connect to your database and start cron job
// Connection();
// cronBackup();
